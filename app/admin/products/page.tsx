...
import { Plus, Edit, Trash2, AlertTriangle, Package, CheckCircle2, Search, Minus } from 'lucide-react'
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSave} className="space-y-4 mt-2">
            ...
            <div>
              <label className="text-sm font-medium text-[#0c2340] mb-1.5 block">Image URL</label>
              <Input value={form.image_url} onChange={(e) => setForm({ ...form, image_url: e.target.value })} placeholder="https://... (optional)" className="border-[#cce7f0]" />
            </div>
