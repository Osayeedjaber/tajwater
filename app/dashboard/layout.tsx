...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const AvatarBubble = ({ size = 8, textSize = 'text-xs' }: { size?: number; textSize?: string }) => (
    <div
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-[#cce7f0] space-y-2">
        <div className="flex items-center gap-3 px-3 py-2">
          <AvatarBubble size={8} textSize="text-xs" />
        ...
        <div className="h-14 bg-white border-b border-[#cce7f0] flex items-center px-4 sm:px-6 gap-4 sticky top-16 z-20">
          ...
          <div className="ml-auto flex items-center gap-3">
            <button className="w-8 h-8 rounded-lg hover:bg-[#e0f7fa] flex items-center justify-center text-[#4a7fa5] relative">
              ...
              <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-[#0097a7]" />
            </button>
